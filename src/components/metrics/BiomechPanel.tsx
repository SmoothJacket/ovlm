...
const styles: Record<string, React.CSSProperties> = {
  ...
  sectionTitle: {
    fontSize: 9, fontWeight: 700, letterSpacing: '0.15em', color: '#d0d4dc',
  ...
  blockTitle: { fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', color: '#d0d4dc' },
  ...
  gaugeTrack: { position: 'relative', height: 6, background: '#f0f0f0', borderRadius: 3, overflow: 'visible' },
  gaugeLabel: { fontSize: 9, color: '#d0d4dc' },
  subRow: { display: 'flex', gap: 12 },
  subMetric: { display: 'flex', flexDirection: 'column', gap: 1 },
  subLabel: { fontSize: 8, color: '#e0e4ec', letterSpacing: '0.08em' },
  subValue: { fontSize: 11, color: '#a0a4ac', fontVariantNumeric: 'tabular-nums' },
  note: { fontSize: 9, color: '#e0e4ec', fontStyle: 'italic', lineHeight: 1.4 },
};
